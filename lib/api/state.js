(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', 'object-assign', 'skatejs/src/api/render'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('object-assign'), require('skatejs/src/api/render'));
  } else {
    var mod = {
      exports: {}
    };
...
})(this, function (exports, module, _objectAssign, _skatejsSrcApiRender) {
  'use strict';
  ...
  var _render = _interopRequireDefault(_skatejsSrcApiRender);
