(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'skatejs-dom-diff/src/render', 'skatejs-named-slots/src/render', 'skatejs-named-slots/src/slot', 'skatejs', 'skatejs/src/api/render'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('skatejs-dom-diff/src/render'), require('skatejs-named-slots/src/render'), require('skatejs-named-slots/src/slot'), require('skatejs'), require('skatejs/src/api/render'));
  } else {
    var mod = {
      exports: {}
    };
