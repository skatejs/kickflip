(function (global, factory) {
  ...
  _incrementalDom.attributes.checked = _incrementalDom.attributes.className = _incrementalDom.attributes.value = _incrementalDom.applyProp;
      ...
      if ((typeof attrs === 'undefined' ? 'undefined' : _typeof(attrs)) === 'object') {
        ...
        for (var _a in attrs) {
          ...
          if (slot && _a === 'name' || _a === slotAttributeName) {
            ...
            val = _data2.default.shadowId + val;
