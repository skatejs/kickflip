(function (global, factory) {
  ...
  _incrementalDom.attributes.checked = _incrementalDom.attributes.value = _incrementalDom.applyProp;
  ...
  function bind(tname) {
    ...
    return factories[tname] = function (attrs, chren) {
      ...
      if ((typeof attrs === 'undefined' ? 'undefined' : _typeof(attrs)) === 'object') {
        (0, _incrementalDom.elementOpenStart)(tname, attrs.key, attrs.statics);
        ...
        for (var _a in attrs) {
          ...
          } else if (!_incrementalDom.attributes[_a] && _a.indexOf('on') === 0) {
            _incrementalDom.attributes[_a] = applyEvent(_a.substring(2));
          }

          (0, _incrementalDom.attr)(_a, val);
        }

        (0, _incrementalDom.elementOpenEnd)();
      } else {
        (0, _incrementalDom.elementOpen)(tname);
        chren = attrs;
      }
  ...
  var slot = exports.slot = bind(slotElementName);
