(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'incremental-dom', 'debounce', './render', '../node_modules/skatejs/lib/index'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('incremental-dom'), require('debounce'), require('./render'), require('../node_modules/skatejs/lib/index'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.incrementalDom, global.debounce, global.render, global.index);
    global.kickflip = mod.exports;
  }
})(this, function (module, exports, _incrementalDom, _debounce, _render, _index) {
  'use strict';
  ...
  function createAttributeLinks(opts) {
    ...
    Object.keys(props).forEach(function (name) {
      ...
      if (typeof prop.attribute === 'undefined') {
        prop.attribute = true;
        _incrementalDom.attributes[name] = _incrementalDom.applyProp;
      }
    });
  }
